<div class="col-xs-12">
  <div class="block-articleDetail">
    ...
    <div class="fullContent">
      <table class="table">
        <tr>
          <td rowspan="2" width="25%"> <img src="<?php echo base_url()?>public/image/avatar.jpg" alt="" style="width: 150px;height: 150px" class="img"></td>
          <td>Nam, Do</td>
    ...
    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
      <div class="row">
        <div class="col-md-3">
          <nav class="block-leftMenu menuPage mrb30">
            ...
            <ul class="nav navbar-nav" style="width: 100%">
              ...
              <li class=""><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="true" aria-controls="collapseOne"><i class="fa fa-angle-right"></i> Thông tin cá nhân</a></li>
              ...
              <li><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="true" aria-controls="collapseOne"><i class="fa fa-angle-right"></i> Thông tin gia đình</a></li>
              <li><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFive" aria-expanded="true" aria-controls="collapseOne"><i class="fa fa-angle-right"></i> Kinh nghiệm làm việc</a></li>
              <li><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseSix" aria-expanded="true" aria-controls="collapseOne"><i class="fa fa-angle-right"></i> Trình độ học vấn</a></li>
              <li><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseSeven" aria-expanded="true" aria-controls="collapseOne"><i class="fa fa-angle-right"></i> Ngoại ngữ tin học</a></li>
            </ul>
          </nav>
       </div>
        ...
        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
          ...
          <div class="form-group row">
            <label for="staticEmail" class="col-sm-4 col-form-label">Họ VÀ TÊN (FULL NAME)</label>
            <div class="col-sm-8">
              <div class="form-group row">
                <div class="col-sm-6">
                <input class="form-control " type="text" placeholder="Họ"> </div>
                <div class="col-sm-6">
                <input class="form-control " type="text" placeholder="Tên"></div>
              </div>
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-sm-6">
              <input class="form-control " type="text" id="ngaysinh"></div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-6">
               <input class="form-control" type="text" id="ngaycap" placeholder="">
            </div>
          </div>
          <div class="form-group row">
        ...
        <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
          <button type="button" class="btn" style="background-color: #f58220 !important;color: white; float: right; margin-bottom: 10px" data-toggle="modal" data-target="#myModal11"> Thêm</button>  
          ...
          <button type="button" class="btn" style="background-color: #f58220 !important;color: white;"> Lưu</button>  
        </div>

        <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
          <label>Quá trình công tác</label>
          <button type="button" class="btn" style="background-color: #f58220 !important;color: white; float: right; margin-bottom: 10px" data-toggle="modal" data-target="#myModal2"> Thêm</button>  
          <table   class="table table-striped table-bordered" > 
            <thead> 
              <tr> 
          ...
          <button type="button" class="btn" style="background-color: #f58220 !important;color: white; float: right; margin-bottom: 10px" data-toggle="modal" data-target="#myModal3"> Thêm</button>
          <table   class="table table-striped table-bordered" > 
            <thead> 
              <tr> 
                <th id="th" width="30%">Họ và tên</th> 
        ...
        <div id="collapseSix" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
          ...
          <button type="button" class="btn" style="background-color: #f58220 !important;color: white; float: right; margin-bottom: 10px" data-toggle="modal" data-target="#myModal4"> Thêm</button>  
          <table   class="table table-striped table-bordered" > 
            <thead> 
              <tr> 
                <th id="th" width="30%">Từ - Đến</th> 
          ...
          <button type="button" class="btn" style="background-color: #f58220 !important;color: white; float: right; margin-bottom: 10px" data-toggle="modal" data-target="#myModal5"> Thêm</button>
          <table   class="table table-striped table-bordered" > 
            <thead> 
              <tr> 
                <th id="th" width="30%">Từ - Đến</th> 
        ...
        <div id="collapseSeven" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
          ...
          <button type="button" class="btn" style="background-color: #f58220 !important;color: white; float: right; margin-bottom: 10px" data-toggle="modal" data-target="#myModal6"> Thêm</button>  
          <table   class="table table-striped table-bordered" > 
            <thead> 
              <tr> 
          ...
          <label>Trình độ tin học</label>
           <button type="button" class="btn" style="background-color: #f58220 !important;color: white; float: right; margin-bottom: 10px" data-toggle="modal" data-target="#myModal7"> Thêm</button>
          <table   class="table table-striped table-bordered" > 
            <thead> 
              <tr> 

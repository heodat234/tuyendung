        ...
        $('#btn_login').click(function(event) {
          ...
          .done(function(data) {
            if (data != '1') {
              ...
              $('.long').html('<label class="dangnhap1"><i class="fa fa-user fa-lg orange" ></i> '+data[0]['operatorname']+'&nbsp|&nbsp <a data-toggle="modal" data-target="#myModalchangepass">Cài đặt</a>&nbsp |&nbsp <a href="<?php echo base_url()?>login/logout">Thoát</a></label>');
